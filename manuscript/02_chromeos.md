...
![Google Docs, Slides and Sheets are three Chrome Apps that come installed on your Chromebook](images/02_chromeos/02_chromebookintro_chromeos-2.png)
...
![The shelf is at the bottom of the screen](images/02_chromeos/02_chromebookintro_chromeos-3.png)
...
![You can click on the launcher button, then the arrow to see more apps](images/02_chromeos/02_chromebookintro_chromeos-4.png)
...
![Pin an app by right clicking](images/02_chromeos/02_chromebookintro_chromeos-7.png)


You will then see the app on your Shelf so you can click on it to be taken directly to that Chrome App. 

![The app is now pinned to your shelf.](images/02_chromeos/02_chromebookintro_chromeos-8.png)
...
![The app is now pinned to your shelf.](images/02_chromeos/02_chromebookintro_chromeos-9.png)
...
![Uncheck Open as Window and click Add to add this website as an app.](images/02_chromeos/02_chromebookintro_chromeos-11.png)
...
![The rstudio.cloud icon now appears on your shelf.](images/02_chromeos/02_chromebookintro_chromeos-12.png)
...
![Search for stackedit on the Chrome Web Store.](images/02_chromeos/02_chromebookintro_chromeos-14.png)
...
![Click add to Chrome and then Add to add the app to your Chrome browser.](images/02_chromeos/02_chromebookintro_chromeos-15.png)


You can then click the Launcher button in the lower left to see that the app has been installed. 


![StackEdit is now installed.](images/02_chromeos/02_chromebookintro_chromeos-16.png)
...
![StackEdit runs in the web browser.](images/02_chromeos/02_chromebookintro_chromeos-17.png)
...
![Click Add to Chrome to add the Pocket extension.](images/02_chromeos/02_chromebookintro_chromeos-18.png)
...
![The Pocket extension comes up as a web browser.](images/02_chromeos/02_chromebookintro_chromeos-19.png)
...
![Click the Pocket icon to save the webpage](images/02_chromeos/02_chromebookintro_chromeos-20.png)

This will save the page for later so that you can read it offline. 


![The page is now saved for offline reading](images/02_chromeos/02_chromebookintro_chromeos-21.png)
...
![Chromebook OS](https://www.youtube.com/watch?v=xnRGU22QevI)
