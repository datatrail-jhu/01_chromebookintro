...
![xkcd suggested a good password combines four random words.](images/07_chromebook_security/07_chromebookintro_security-2.png)
...
![Open your personal settings](images/07_chromebook_security/07_chromebookintro_security-3.png)

Once you have your personal settings open you can click on the "Screen Lock" settings.

![Open the Screen Lock settings.](images/07_chromebook_security/07_chromebookintro_security-4.png)

You'll be required to input your (hopefully good!) password. 


![Input your password.](images/07_chromebook_security/07_chromebookintro_security-5.png)
...
![Click on Manage Other People to manage users of your Chromebook.](images/07_chromebook_security/07_chromebookintro_security-7.png)
...
![Click on the option to restrict users.](images/07_chromebook_security/07_chromebookintro_security-8.png)
...
![Go to the two step verification page and click Get Started.](images/07_chromebook_security/07_chromebookintro_security-9.png)


This will take you through the two step verification set up process. First you will again need to click "Get Started".

![Click Get Started.](images/07_chromebook_security/07_chromebookintro_security-10.png)

Then you will be required to enter your password to confirm that it really is you trying to step two step verification. 

![Enter your password.](images/07_chromebook_security/07_chromebookintro_security-11.png)
...
![Enter the phone number of the phone you will use for two step verification.](images/07_chromebook_security/07_chromebookintro_security-12.png)
...
![Your account security page.](images/07_chromebook_security/07_chromebookintro_security-16.png)
...
![Your security events tell you about when your password or two step verification settings have changed.](images/07_chromebook_security/07_chromebookintro_security-17.png)
...
![Your recently used devices tells you what devices have logged into your account.](images/07_chromebook_security/07_chromebookintro_security-18.png)
...
![You can see which apps have access to your account.](images/07_chromebook_security/07_chromebookintro_security-19.png)
...
![You can remove access for specific apps by clicking on them.](images/07_chromebook_security/07_chromebookintro_security-20.png)
